...
The contact sheet is for preview only. Print the eight individual PNG files at their embedded 1200 DPI size, or use the new [Letter-size grid](print_sheets/README.md). That folder contains an editable eight-layer GIMP XCF, a matching actual-size PDF, and instructions for rearranging other open GIMP sheets.
