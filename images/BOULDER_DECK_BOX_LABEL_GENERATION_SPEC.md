...
2. Draw the one-line deck title at baseline y=740. Start around 340 px condensed bold uppercase and reduce as needed, with a suggested minimum of 220 px.
3. Draw an 8 px accent divider at y=605.
4. Draw the one-line description at baseline y=450. Start around 150 px condensed uppercase and reduce as needed, with a suggested minimum of 104 px.
5. Draw an 8 px accent divider at y=340.
